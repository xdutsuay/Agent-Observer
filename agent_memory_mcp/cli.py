...
def entry():
    ...
    serve_parser.add_argument("--ui", action="store_true", help="Serve built UI from ui/dist")
    serve_parser.add_argument(
        "--no-watcher",
        action="store_true",
        help="Do not auto-start filesystem watcher",
    )
    ...
    if args.command == "serve":
        run(
            ...
            root=args.root,
            serve_ui=args.ui,
            auto_watcher=not args.no_watcher,
        )
